  ...
  return (
    ...
    >
      <SplashIntro
        ...
        flapWidth="clamp(34px, 4.6vw, 74px)"
        scrollThreshold={280}
      />
      <TopNav variant="dark" />
      ...
      */}
      ...
      {/*
        Au scroll max, la vue est ancrée au BAS (footer). Le globe se positionne
        donc relativement au bas, pas au spacer du haut. On groupe globe + texte
